...
If at any point you want to go to the previous question to answer it again, send the message "Back". With this you can change your answer in a previous question. After 20 minutes, the program will exit if the setup process is not done.`,
    ...
    const questions = [
      ...
      "What is the ID of the Team's manager role? (right click the role -> Copy Role ID. If you can't see a Copy Role ID option, make sure you have enabled Developer Mode) A team manager can recruit and kick players from the team's roster. If there are multiple teams, seperate the IDs using a comma (The order should be the same as the one you used in the previous step).",
